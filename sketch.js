...
function setup() {
  ...
  //contain the frame data in it
  var boatFrames = boatSpritedata.frames;

  //Using the for loop, we’ll loop on the length of the boatFrames
  for (var i = 0; i < boatFrames.length; i++) {
    //get the position of each frame
    var pos = boatFrames[i].position;
    // to get the image from the boatSpritesheet which matches the position that we got in the pos variable 
    var img = boatSpritesheet.get(pos.x, pos.y, pos.w, pos.h);
    //push this image to the boatAnimation array.
